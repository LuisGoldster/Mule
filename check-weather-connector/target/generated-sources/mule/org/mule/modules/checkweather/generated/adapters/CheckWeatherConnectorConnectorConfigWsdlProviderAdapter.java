...
/**
 * A <code>CheckWeatherConnectorConnectorConfigWsdlProviderAdapter</code> is a wrapper around {@link CheckWeatherConnector } that represents the WSDL generic connector {@link ConnectorConfig }
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-04-17T07:57:22+07:00", comments = "Build UNNAMED.2762.e3b1307")
public class CheckWeatherConnectorConnectorConfigWsdlProviderAdapter implements ProcessAdapter<WsdlAdapter> , Disposable, ConnectorMetaDataEnabled, WsdlAdapter
{

    private WSResolver wsResolver;
    private ConnectorConfig config;
    protected CheckWeatherConnectorProcessAdapter connector;
    ...
    {
        if (connector == null) {
            connector = new CheckWeatherConnectorProcessAdapter();
     ...
     * 
     */
    public CheckWeatherConnectorProcessAdapter getConnector() {
        if (connector == null) {
            try {
